...
public class TokenStream
{
                ...
                int lineno)
    {
        ...
        if (sourceReader != null) {
        	this.sourceReader = sourceReader;  // Bug #1, it was: this.sourceReader = null;
        ...
        for (;;) {
            ...
            if (c == '\\') {
                ...
                if (c == 'u') {
                    ...
                    isUnicodeEscapeStart = true; // Bug #4, there was no such statement, so I was not able to recognize unicode
                    stringBufferTop = 0;
                } else {
            ...
            case '-':
                if (matchChar('=')) {
                    ...
                    c = Token.SUB;    //Bug #2, it was: c = Token.ADD; 
                }
                return c;
    ...
    public int getTokenLength() {
     ...
     static double stringToNumber(String s, int start, int radix) {
         ...
         for (end=start; end < len; end++) {
             char c = s.charAt(end);
             int newDigit;
             if ('0' <= c && c <= digitMax)  // Bug #3, it was:   if ('0' <= c && c < digitMax)
                 newDigit = c - '0';
             else
                 break;
